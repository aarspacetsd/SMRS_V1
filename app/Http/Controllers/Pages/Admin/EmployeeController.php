...
class EmployeeController extends Controller
{
  ...
  public function index()
  {
    ...
    return view('content.pages.admin.employee', compact('employees', 'departments'));
  ...
  {
    $departments = Department::select('id', 'name')->get();
    return view('content.pages.admin.employee.create', compact('departments'));
  }
  ...
  public function show($id)
  {
    ...
    return view('content.pages.admin.employee.profile', compact('employee', 'departments'));
    //
  }
  ...
  public function edit($id)
  {
    ...
    return view('content.pages.admin.employee.edit', compact('employee', 'departments', 'working_day'));
  }
  ...
  public function destroy($id)
  {
    ...
    $employee->delete();
    return redirect()->route('employees.index')->with('success', 'Employee Deletetd Successfully');
  }
}
